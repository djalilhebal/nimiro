...
/**
 * Modifications copyright (C) 2018 Djalil Dreamski
 */

/**
 * Encode a word as its consonant sounds à la DoubleMetaphone
 * Based on DoubleMetaphone.java (org.apache.commons.codec.language.DoubleMetaphone)
 * 
 * @example
 * myMetaphone('Maliciously') === 'MLXSL'
 * 
 * @param {string} input - Word to be encoded
 * @returns {string} - MyMetaphone encoding
 */
module.exports = function myMetaphone(input) {
